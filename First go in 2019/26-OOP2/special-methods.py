...
class Human:
    ...
    def __mul__(self, other):
        ...
        if isinstance(other, int):
            # MUST BE A CLONE, otherwise they are just referneces to the same place in memory, if we change 1, it changes everywhere
...
# print(j)
# print(len(j))
# print(j + k) - "Human neamed Newborn Larsen aged 0" - repr of a new Human
